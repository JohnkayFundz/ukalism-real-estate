...
-- IMPORTANT: replace deejayjohnkay@gmail.com with the exact email you will use for the admin account.
...
-- Add video support to existing databases without affecting existing listings.
